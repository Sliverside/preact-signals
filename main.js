...
(function () {
  ...
  effect(() => {
    button.innerText = Mustache.render(button.getAttribute('m-template'), { counter: counter.value })
  })
})();

(function () {
  const fields = document.querySelectorAll('.field')
  for (let i = 0; i < fields.length; i++) new Field(fields[i])
  ...
  function Field(field) {
    ...
    const Select = function (field) {
      ...
      this.selectedsDisplay = createElement('div', {
        classList: ['field__selectedsOptions']
      })
